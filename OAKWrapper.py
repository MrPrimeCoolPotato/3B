...
class OAKCamColor:
    def __init__(self, fps: float = 30.0, previewWidth: int = 300, previewHeight: int = 300, interleaved: bool = False, colorOrder: dai.ColorCameraProperties.ColorOrder = dai.ColorCameraProperties.ColorOrder.RGB):
        # Create pipeline
...
class OAKCamColorDepth:
    def __init__(self, fps: float = 30.0, previewWidth: int = 300, previewHeight: int = 300, interleaved: bool = False, colorOrder: dai.ColorCameraProperties.ColorOrder = dai.ColorCameraProperties.ColorOrder.RGB, LRCheck: bool = False):
        # Create pipeline
        pipeline = dai.Pipeline()
    ...
    def getDepthFrameColorMapped(self):
        ...
        inDepth = cv2.normalize(inDepth, None, 0, 255, cv2.NORM_MINMAX, cv2.CV_8U)
        inDepth = cv2.applyColorMap(inDepth, cv2.COLORMAP_JET)
        return inDepth